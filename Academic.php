    ...
    <div class="featured-blocks">
        ...
        <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:480px;overflow:hidden;visibility:hidden;">
            ...
            <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
                <div>
                    <img data-u="image" src="img/aca1.jpg" />
                    <img data-u="thumb" src="img/aca1.jpg" />
                </div>
                <div>
                    <img data-u="image" src="img/aca2.jpg" />
                    <img data-u="thumb" src="img/aca2.jpg" />
                </div>
                <div>
                    <img data-u="image" src="img/aca3.jpg" />
                    <img data-u="thumb" src="img/aca3.jpg" />
                </div>
                <div>
                    <img data-u="image" src="img/aca4.jpg" />
                    <img data-u="thumb" src="img/aca4.jpg" />
                </div>
                <div>
                    <img data-u="image" src="img/aca5.jpg" />
                    <img data-u="thumb" src="img/aca5.jpg" />
                </div>
                <div>
                    <img data-u="image" src="img/aca6.jpg" />
                    <img data-u="thumb" src="img/aca6.jpg" />
                </div>
                4
