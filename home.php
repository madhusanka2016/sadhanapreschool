 ...
 <section class="hero-area">
     <div class="hero-slides owl-carousel">
         ...
         <!-- Single Hero Slide -->
         <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/cover1.jpg);">
         ...
         <!-- Single Hero Slide -->
         <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/cover2.jpg);">
             <div class="container h-100">
                 <div class="row h-100 align-items-center">
                     <div class="col-12">
                         <div class="hero-slides-content">
                             <h4 data-animation="fadeInUp" data-delay="200ms" style="text-shadow: 2px 2px 10px #000000;">Discover the Future World</h4>
                             <h2 data-animation="fadeInUp" data-delay="400ms" style="text-shadow: 5px 5px 10px #000000;">Achieve Your Professinal Qualifications</h2>
                             <!--<a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read More</a> -->
                             </div>
                     </div>
                 </div>
         ...
         <!-- Single Hero Slide -->
         <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/cover3.jpg);">
             <div class="container h-100">
                 <div class="row h-100 align-items-center">
                     <div class="col-12">
                         <div class="hero-slides-content">
                             <h4 data-animation="fadeInUp" data-delay="200ms" style="text-shadow: 2px 2px 10px #000000;">Achieve Your Future Dreams</h4>
                             <h2 data-animation="fadeInUp" data-delay="400ms" style="text-shadow: 5px 5px 10px #000000;">Learn World <br>Cutting Edge Technologies</h2>
                             <!--<a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read More</a> -->
                             </div>
                     </div>
                 </div>
         ...
         <!-- Single Hero Slide -->
         <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/cover4.jpg);">
             <div class="container h-100">
                 <div class="row h-100 align-items-center">
                     <div class="col-12">
                         <div class="hero-slides-content">
                             <h4 data-animation="fadeInUp" data-delay="100ms" style="text-shadow: 2px 2px 10px #000000;">Englighen Your Kids Future</h4>
                             <h2 data-animation="fadeInUp" data-delay="400ms" style="text-shadow: 5px 5px 10px #000000;">Teach to <br>Explore the World</h2>
                             <!--<a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read More</a> -->
                             </div>
                     </div>
                 </div>
 ...
 <!-- ##### Hero Area End ##### --> 
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="course-content">
                            ...
                            <p>For all courses, contents are created to recently updated concepts to gain Preofessional Qualifications.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Course Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="course-content">
                            ...
                            <p>Use new cutting as technology for sylabus and also as teaching methods.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Course Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="course-content">
                            <h4>Theory and Practicals</h4>
                            <p>Provide best education using conducting Theory and Practical Sessions.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Course Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <div class="course-content">
                            <h4>100% Guarantee</h4>
                            <p>Over 17 years proven guarantee for enrich your knowledge.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Course Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="700ms">
                        ...
                        <div class="course-content">
                            <h4>Recognized Cerficates</h4>
                            <p>Locally and Internationally Recognized Cerficates.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Course Area -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="800ms">
                        ...
                        <div class="course-content">
                            ...
                            <p>Carrier Guidance for the students in the Local and International Job Market.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="testimonials-area section-padding-100 bg-img bg-overlay" style="background-image: url(img/bg-img/ideas.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto white wow fadeInUp" data-wow-delay="300ms">
                        <span>our testimonials</span>
                        <h3>See what our Past Students are saying about us</h3>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
             ...
             <div class="col-12 col-lg-6">
                 <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                     <div class="popular-course-content">
                         <h5>Diploma in Information Techonology</h5>
                         <span>For - Beginners  |  Students | Kids </span>
                         
                         <p>1st Step for the Information Technology for any Kid, School Children and Adult who need to discover World.!</p>
                         <a href="contact-us.php" class="btn academy-btn btn-sm">Contact Us For More >></a>
                     </div>
             ...
             <div class="col-12 col-lg-6">
                 <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="900ms">
                     <div class="popular-course-content">
                         ...
                         <span>For - Students  |  Employees</span>
                         
                         <p>For students who wish to learn funderments of Web Designing and also for learn Web Desiging for Higher education or as a Carrier</p>
                         <a href="contact-us.php" class="btn academy-btn btn-sm">Contact Us For More >></a>
                     </div>
             ...
             <div class="col-12 col-lg-6">
                 <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                     <div class="popular-course-content">
                         <h5>Certificate in Graphic Designing</h5>
                         <span>For - Job Expectors   |  Beginner in designing</span>
                         
                         <p>For who are wishing to start their carrier with Compuster Aided Designing and also for Students who interest in Designing using Computers.</p>
                         <a href="contact-us.php" class="btn academy-btn btn-sm">Contact Us For More >></a>
                     </div>
             ...
             <div class="col-12 col-lg-6">
                 <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="600ms">
                     <div class="popular-course-content">
                         <h5>Certificate in Hardware Engineering</h5>
                         <span>For - Job Expectors   |  Beginners</span>
                         
                         <p>For any one who wish to explore the Computer Hardware World and also for Who wish to build a Computer from Scrach as a hobby or job.</p>
                         <a href="contact-us.php" class="btn academy-btn btn-sm">Contact Us For More >></a>
                     </div>
    ...
    <div class="col-12">
                 <div class="view-all text-center wow fadeInUp" data-wow-delay="800ms">
                     <a href="courses.php" class="btn academy-btn">Explore More </a>
                 </div>
             </div>
         </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                        ...
                        <a href="#"><img src="img/clients-img/partner-1.png" width="500px" ></a>
